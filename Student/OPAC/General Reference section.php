...
<div class="navbar">
  ...
  <li class="dropdown">
    <a href="#"
         ...
         <i class="icon-book icon-large"></i>General Reference Section
          <b class="caret"></b>    </a>
...
<div id="sections">
  <div align="left" class="style2 style1 style1 style1">GENERAL REFERENCE SECTION</div>
  <br/>
  <br/>
  <span class="style2"> - Includes encyclopedias, atlases, almanacs, dictionaries, biographies, and yearbooks.</span></div>
