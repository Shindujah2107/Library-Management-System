...
<?php
  ...
  {
    mysqli_query($db,"UPDATE  issue_book SET  approve =  '$_POST[approve]', issuedate =  '$_POST[issue]', returndate =  '$_POST[return]' WHERE username='$_SESSION[name]' and bid='$_SESSION[bid]';");
