				...
				if(mysqli_num_rows($sql) == 0){
					...
					while($row = mysqli_fetch_assoc($sql)){
						...
						<tr>
							...
							<td><a href="profileb.php?book_isbn='.$row['book_isbn'].'"><span class="glyphicon glyphicon-book" aria-hidden="true"></span> '.$row['book_image'].'</a></td>
							...
							<td>
								...
								<a href="editb.php?book_isbn='.$row['book_isbn'].'" title="Edit Data" class="btn btn-primary btn-sm"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a>
