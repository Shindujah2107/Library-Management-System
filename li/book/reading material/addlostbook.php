...
<?php
    if(isset($_POST['submit']))
    {
        ...
        mysqli_query($db,"INSERT INTO books1 VALUES ('$_POST[bid]', '$_POST[bookname]','$_POST[isbn1]', '$_POST[author1]', '$_POST[edition1]','$_POST[purchasedate1]','$_POST[language1]','$_POST[status1]', '$_POST[quantity1]','$_POST[department1]' );");
        ?>
