...
<br>
   ...
   <tr style='background-color: #6db6b9e6;'>
    ...
    while($row = $result->fetch(PDO::FETCH_ASSOC)) {         
        ...
        echo "<td><a href=\"editpublisher2.php?id=$row[id]\">Edit</a> | <a href=\"deletepublisher.php?id=$row[id]\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a></td>";        
    echo "</tr>";
	}
    ?>
    </table>
