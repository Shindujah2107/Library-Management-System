		...
		<div class="container">
			...
			<div id="navbar" class="navbar-collapse collapse">
				<ul class="nav navbar-nav">
					<li class="active"><a href="indexe.php">Employee Details</a></li>
					...
					while($row = mysqli_fetch_assoc($sql)){
						...
						<tr>
							...
							<td>
								...
								<a href="indexe.php?aksi=delete&eid='.$row['eid'].'" title="Delete Data" onclick="return confirm(\'Do you want to  delete '.$row['ename'].'?\')" class="btn btn-danger btn-sm"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>
							</td>
						</tr>
						';
